...
interface InterfazConexion {
    ...
    fun actualizarRecord(record:Int, playerName: String, context: Context):Record //Esto declara una función que debe actualizar el record y devolver el record actualizado
    //También recibe Context y el nombre del jugador
}